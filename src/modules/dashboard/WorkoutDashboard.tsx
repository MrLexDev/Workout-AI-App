...
export const WorkoutDashboard: React.FC = () => {
    ...
    const { routines, selectRoutine } = useWorkoutStore();
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                {routines.map((routine) => (
                    <div
                        key={routine.id}
                        className="bg-slate-800 rounded-xl p-5 border border-slate-700 hover:border-blue-500/50 transition-colors"
                    >
                  ...
                  {ex.name}
                        ...
                        <button
                            ...
                            className="w-full bg-blue-600 text-white font-semibold py-3 rounded-lg flex items-center justify-center gap-2 active:scale-[0.98] transition-transform cursor-pointer"
                        >
